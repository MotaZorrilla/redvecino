...
class CommonExpensePeriodReceiptsTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function get_receipts_paginated_returns_length_aware_paginator()
    {
    ...
    /** @test */
    public function get_receipts_paginated_respects_page_parameter()
    {
        $this->seed(\Database\Seeders\RolePermissionSeeder::class);
        $this->seed(\Database\Seeders\DatabaseSeeder::class);
    ...
    /** @test */
    public function get_receipts_filters_by_property_id()
    {
        $this->seed(\Database\Seeders\RolePermissionSeeder::class);
        $this->seed(\Database\Seeders\DatabaseSeeder::class);
    ...
    /** @test */
    public function get_receipts_default_per_page_when_not_provided()
    {
        $this->seed(\Database\Seeders\RolePermissionSeeder::class);
        $this->seed(\Database\Seeders\DatabaseSeeder::class);
