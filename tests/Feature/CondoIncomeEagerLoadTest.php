...
class CondoIncomeEagerLoadTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function condo_income_seeder_uses_eager_loading_no_n_plus_one()
    {
    ...
    /** @test */
    public function condo_income_from_fines_also_uses_eager_loading()
    {
        $this->seed(\Database\Seeders\RolePermissionSeeder::class);
        $this->seed(\Database\Seeders\DatabaseSeeder::class);
