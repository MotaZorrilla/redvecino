...
class PaymentTimestampTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function payment_created_at_equals_payment_date()
    {
    ...
    /** @test */
    public function payment_created_at_uses_carbon_parse_for_consistency()
    {
        $this->seed(\Database\Seeders\RolePermissionSeeder::class);
        $this->seed(\Database\Seeders\DatabaseSeeder::class);
