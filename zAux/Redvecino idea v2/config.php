...
try {
    ...
    // Tablas para listas de chequeo de áreas comunes
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS checklist_registros (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS checklist_registro_detalles (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    $tablesToMigrate = ['propiedades', 'colaboradores', 'egresos', 'periodos_gasto_comun', 'areas_comunes', 'arriendos_areas', 'ficha_residentes', 'pedidos_insumos'];
