...
<head>
    ...
    <style>
        :root {
            ...
            --accent-color: #488891;
            --accent-hover: #3d737a;
            --accent-gradient: linear-gradient(135deg, #488891 0%, #072a6a 100%);
            --accent-glow: rgba(72, 136, 145, 0.18);
            --emerald-gradient: linear-gradient(135deg, #348059 0%, #0a6a20 100%);
            --rose-gradient: linear-gradient(135deg, #f43f5e 0%, #991b1b 100%);
            --danger: #ef4444;
            --warning: #f59e0b;
            --success: #348059;
...
<body>
    ...
    <div id="portal-role-container" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; background: radial-gradient(circle at top right, #1e1b4b, #09090b); padding: 2rem; font-family: 'Outfit', sans-serif;">
        <div style="text-align: center; margin-bottom: 3rem; max-width: 600px; display: flex; flex-direction: column; align-items: center; gap: 1rem;">
            <div>
                <img src="assets/logo_complete.png" alt="RedVecino" style="max-height: 110px; width: auto; filter: drop-shadow(0 6px 16px rgba(0,0,0,0.4));">
            </div>
            <p style="font-size: 0.95rem; color: var(--text-secondary); margin-top: 0.5rem;">Seleccione el perfil de acceso correspondiente para ingresar a la plataforma.</p>
        </div>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; max-width: 1100px; width: 100%;">
            <!-- Card TI -->
            <div onclick="switchRole('ti')" style="background: rgba(7,42,106,0.15); border: 1px solid rgba(72,136,145,0.15); border-radius: 16px; padding: 2rem; cursor: pointer; transition: all 0.3s; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; min-height: 240px; backdrop-filter: blur(12px);" onmouseover="this.style.transform='translateY(-6px)'; this.style.borderColor='rgba(72,136,145,0.5)'; this.style.boxShadow='0 20px 40px rgba(72,136,145,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.borderColor='rgba(72,136,145,0.15)'; this.style.boxShadow='none';">
                <div>
                    <div style="background: linear-gradient(135deg, #488891, #072a6a); border-radius: 12px; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; box-shadow: 0 4px 12px rgba(72,136,145,0.3);">
                ...
                <div style="display: flex; align-items: center; gap: 0.25rem; font-size: 0.8rem; font-weight: 600; color: #488891; margin-top: 1.5rem;">
            ...
            <!-- Card Copropietario -->
            <div onclick="switchRole('usuario')" style="background: rgba(10,106,32,0.15); border: 1px solid rgba(52,128,89,0.15); border-radius: 16px; padding: 2rem; cursor: pointer; transition: all 0.3s; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; min-height: 240px; backdrop-filter: blur(12px);" onmouseover="this.style.transform='translateY(-6px)'; this.style.borderColor='rgba(52,128,89,0.5)'; this.style.boxShadow='0 20px 40px rgba(52,128,89,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.borderColor='rgba(52,128,89,0.15)'; this.style.boxShadow='none';">
                <div>
                    <div style="background: linear-gradient(135deg, #348059, #0a6a20); border-radius: 12px; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; box-shadow: 0 4px 12px rgba(52,128,89,0.3);">
                ...
                <div style="display: flex; align-items: center; gap: 0.25rem; font-size: 0.8rem; font-weight: 600; color: #348059; margin-top: 1.5rem;">
                    <span>Ingresar</span> <i data-lucide="arrow-right" style="width: 14px; height: 14px;"></i>
                </div>
            </div>

            <!-- Card Colaborador -->
            <div onclick="switchRole('colaborador')" style="background: rgba(72,136,145,0.1); border: 1px solid rgba(72,136,145,0.15); border-radius: 16px; padding: 2rem; cursor: pointer; transition: all 0.3s; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; min-height: 240px; backdrop-filter: blur(12px);" onmouseover="this.style.transform='translateY(-6px)'; this.style.borderColor='rgba(72,136,145,0.5)'; this.style.boxShadow='0 20px 40px rgba(72,136,145,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.borderColor='rgba(72,136,145,0.15)'; this.style.boxShadow='none';">
                <div>
                    <div style="background: linear-gradient(135deg, #488891, #348059); border-radius: 12px; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; box-shadow: 0 4px 12px rgba(72,136,145,0.3);">
    ...
    <div id="role-colaborador-container" style="display: none; min-height: 100vh; background: #09090b; padding: 2rem; font-family: 'Outfit', sans-serif;">
        ...
        <!-- Calendario de Reservas para Colaboradores (Entrega y Recepción) -->
        <div class="card-panel" style="padding: 1.5rem; margin-top: 1.5rem;" id="portal-colaborador-reservas-panel">
            <h4 style="margin: 0 0 1rem 0; font-size: 0.95rem; color: #fff; font-weight: 700; border-bottom: 1px solid var(--border-color); padding-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">
                <i data-lucide="calendar" style="color: #fbbf24; width: 18px; height: 18px;"></i> Calendario de Áreas Comunes en Arriendo
            </h4>
            <p style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 1rem;">
                Haga click sobre una reserva en el calendario para realizar la entrega o recepción del área común con su correspondiente checklist y registro fotográfico.
            </p>
            
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem; flex-wrap: wrap; gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <button class="btn btn-secondary" onclick="changeColabCalendarMonth(-1)" style="padding: 0.35rem 0.6rem; min-width: auto; height: auto;">
                        <i data-lucide="chevron-left" style="width:16px; height:16px;"></i>
                    </button>
                    <h3 id="colab-calendar-month-title" style="margin: 0; font-size: 1.05rem; color: #fff; font-weight: 600; min-width: 160px; text-align: center;">Mes Año</h3>
                    <button class="btn btn-secondary" onclick="changeColabCalendarMonth(1)" style="padding: 0.35rem 0.6rem; min-width: auto; height: auto;">
                        <i data-lucide="chevron-right" style="width:16px; height:16px;"></i>
                    </button>
                </div>
                <div style="display: flex; gap: 0.75rem; font-size: 0.75rem; color: var(--text-secondary); flex-wrap: wrap; align-items: center;" id="colab-areas-legend">
                    <!-- Leyenda dinámica -->
                </div>
            </div>
            
            <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 1px; background: var(--border-color); border: 1px solid var(--border-color); border-radius: 8px 8px 0 0; overflow: hidden;">
            ...
            <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 1px; background: var(--border-color); border: 1px solid var(--border-color); border-radius: 0 0 8px 8px; overflow: hidden;" id="colab-calendar-grid">
                <!-- Carga dinámica -->
            </div>
        </div>
    </div>
    ...
    <div class="app-container" style="display: none;">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="brand">
                <div class="brand-logo" style="overflow: hidden; padding: 2px; display: flex; align-items: center; justify-content: center; background: none; box-shadow: none; border-radius: 8px;">
                    <img src="assets/logo_icon.png" alt="Logo" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                </div>
            ...
            <div id="view-colaboradores-container" class="view-container" style="display: none;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; gap: 1rem; flex-wrap: wrap;">
                    ...
                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                        <button class="btn btn-secondary" onclick="openAdminInsumosModal()" style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; padding: 0.6rem 1.2rem;">
                            <i data-lucide="shopping-bag" style="width: 16px; height: 16px;"></i> Pedido de Materiales
                        </button>
                ...
                <!-- Notificación de lista de compras pendientes -->
                <div id="admin-insumos-alert-box" style="display: none; background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.25); border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem; justify-content: space-between; align-items: center; gap: 1rem; flex-wrap: wrap;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <div style="background: rgba(245, 158, 11, 0.15); border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; color: #fbbf24; flex-shrink: 0;">
                            <i data-lucide="shopping-bag" style="width: 18px; height: 18px;"></i>
                        </div>
                        <div>
                            <div style="font-size: 0.85rem; font-weight: 700; color: #fff;">Lista de Compra Pendiente de Revisión</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary);" id="admin-insumos-alert-text">Hay insumos o materiales pendientes de compra solicitados por los colaboradores.</div>
                        </div>
                    </div>
                    <button class="btn btn-secondary" onclick="openAdminInsumosModal()" style="font-size: 0.8rem; padding: 0.4rem 0.8rem; display: flex; align-items: center; gap: 0.25rem; height: 34px;">
                        <i data-lucide="eye" style="width: 14px; height: 14px;"></i> Ver Lista Completa
                    </button>
                </div>
                            ...
                            <div class="categories-grid" style="display: grid; grid-template-columns: 1fr 1.25fr; gap: 1.5rem;">
                                ...
                                <div>
                                    ...
                                    <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px dashed var(--border-color);">
                                        <button type="button" class="btn btn-secondary" onclick="setupDefaultEstructuraRedVecino()" style="width: 100%; font-size: 0.85rem; padding: 0.5rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: rgba(16, 185, 129, 0.05); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.25);">
                                            <i data-lucide="sparkles" style="width: 14px; height: 14px;"></i> Cargar Estructura Oficial RedVecino
                                        </button>
                                        <small style="color: var(--text-muted); display: block; margin-top: 0.25rem; font-size: 0.75rem;">Configura automáticamente los 4 bloques principales oficiales de cobro de RedVecino.</small>
                                    </div>
                                </div>
    ...
    <div class="onboarding-overlay" id="onboarding-overlay">
        <div class="onboarding-card">
            ...
            <button class="btn btn-primary" style="margin-top: 1rem; width: 100%; justify-content: center; font-weight: 600;" onclick="startOnboarding()">
                Comenzar a Crear Categorías Manualmente <i data-lucide="arrow-right"></i>
            </button>
            <button class="btn btn-secondary" style="margin-top: 0.5rem; width: 100%; justify-content: center; font-weight: 600; background: rgba(16, 185, 129, 0.1); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.3);" onclick="setupDefaultEstructuraRedVecino()">
                <i data-lucide="sparkles" style="width: 16px; height: 16px; margin-right: 6px;"></i> Cargar Estructura Oficial RedVecino (Recomendado)
            </button>
        </div>
    </div>
            ...
            <div class="modal-body" style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 1.5rem; padding: 1.5rem;">
                ...
                <div>
                    ...
                    <form id="form-area-comun" onsubmit="submitAreaComunForm(event)">
                        ...
                        <div style="border-top: 1px solid var(--border-color); padding-top: 1rem; margin-top: 1rem; margin-bottom: 1rem;">
                            <label style="font-size: 0.85rem; color: #fff; font-weight: 600; display: block; margin-bottom: 0.25rem;">Lista de Chequeo (Entrega/Recepción)</label>
                            <span style="font-size: 0.7rem; color: var(--text-secondary); display: block; margin-bottom: 0.75rem;">Defina los ítems que el colaborador debe revisar al entregar y recibir esta área común.</span>
                            
                            <div style="display: flex; gap: 0.5rem; margin-bottom: 0.75rem;">
                                <input type="text" id="area-comun-nuevo-item" class="form-control" placeholder="Ej: Estado de limpieza de parrilla" style="font-size: 0.8rem; padding: 0.35rem 0.5rem; height: 34px;">
                                <button type="button" class="btn btn-secondary" onclick="addAreaComunChecklistItem()" style="padding: 0 0.75rem; font-size: 0.8rem; white-space: nowrap; height: 34px; display: flex; align-items: center; gap: 0.25rem;">
                                    <i data-lucide="plus" style="width: 14px; height: 14px;"></i> Agregar
                                </button>
                            </div>
                            
                            <ul id="area-comun-checklist-preview" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.4rem; max-height: 120px; overflow-y: auto; border: 1px solid var(--border-color); border-radius: 6px; padding: 0.4rem; background: rgba(0,0,0,0.1);">
                                <!-- Vista previa dinámica de items -->
                            </ul>
                        </div>
    ...
    <!-- ================= MODAL: PEDIDO DE MATERIALES (ADMINISTRADOR) ================= -->
    <div class="modal-overlay" id="modal-admin-insumos">
        <div class="modal-card" style="max-width: 700px;">
            <div class="modal-header">
                <span class="modal-title">Pedido de Materiales e Insumos</span>
                <button class="modal-close" onclick="closeAdminInsumosModal()"><i data-lucide="x"></i></button>
            </div>
            <div class="modal-body" style="padding: 1.5rem;">
                <p style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 1.25rem;">
                    Revise las solicitudes de compra hechas por el personal del condominio. Al marcar el check general, la lista de insumos pasará al estado "En Proceso de Compra" y se bloqueará para el colaborador.
                </p>
                
                <div id="admin-insumos-lists-container" style="display: flex; flex-direction: column; gap: 1.5rem;">
                    <!-- Cargado dinámicamente -->
                </div>
            </div>
        </div>
    ...
    <!-- ================= MODAL: REGISTRO DE CHECKLIST (COLABORADOR) ================= -->
    <div class="modal-overlay" id="modal-checklist-registro">
        <div class="modal-card" style="max-width: 600px;">
            <div class="modal-header">
                <span class="modal-title" id="checklist-modal-title">Entrega / Recepción de Área Común</span>
                <button class="modal-close" onclick="closeChecklistRegistroModal()"><i data-lucide="x"></i></button>
            </div>
            <div class="modal-body" style="padding: 1.5rem;">
                <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); padding: 0.75rem; border-radius: 6px; margin-bottom: 1rem; font-size: 0.85rem;" id="checklist-info-reserva">
                    <!-- Información contextual del arriendo -->
                </div>
                
                <form id="form-checklist-registro" onsubmit="submitChecklistRegistroForm(event)" enctype="multipart/form-data">
                    <input type="hidden" id="checklist-arriendo-id" value="">
                    <input type="hidden" id="checklist-tipo" value="">
                    
                    <div style="margin-bottom: 1.25rem;">
                        <label style="font-size: 0.85rem; color: #fff; font-weight: 600; display: block; margin-bottom: 0.5rem;">Ítems de Chequeo</label>
                        <div id="checklist-items-container" style="display: flex; flex-direction: column; gap: 0.75rem;">
                            <!-- Dinámico -->
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-primary" style="width: 100%; font-size: 0.9rem; padding: 0.6rem;" id="btn-save-checklist">
                        Guardar Registro y Cierre
                    </button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        function setupDefaultEstructuraRedVecino() {
            if (!confirm('¿Confirma que desea cargar la Estructura Oficial de RedVecino? Esto configurará automáticamente los 4 bloques de cobro (Remuneraciones, Servicios Básicos, Mantenciones y Fondos/Multas) con sus respectivas subcategorías. Esta acción reemplazará la estructura actual de categorías vacías.')) {
                return;
            }

            fetch('api.php?action=setup_default_categories_redvecino', {
                method: 'POST'
            })
            .then(res => res.json())
            .then(response => {
            ...
            .catch(() => showToast('Error al configurar la estructura de categorías.', 'error'));
        }
        ...
        let activeAreaChecklistItems = [];

        function addAreaComunChecklistItem() {
            const input = document.getElementById('area-comun-nuevo-item');
            const item_nombre = input.value.trim();
            if (item_nombre === '') {
                showToast('Escriba un nombre para el ítem de chequeo.', 'warning');
                return;
            }
            if (activeAreaChecklistItems.includes(item_nombre)) {
                showToast('Este ítem ya está en la lista.', 'warning');
                return;
            }
            activeAreaChecklistItems.push(item_nombre);
            input.value = '';
            renderActiveAreaChecklistPreview();
        }

        function removeActiveAreaChecklistItem(index) {
            activeAreaChecklistItems.splice(index, 1);
            renderActiveAreaChecklistPreview();
        }

        function renderActiveAreaChecklistPreview() {
            const container = document.getElementById('area-comun-checklist-preview');
            if (!container) return;
            container.innerHTML = '';
            
            if (activeAreaChecklistItems.length === 0) {
                container.innerHTML = '<span style="color: var(--text-muted); font-size: 0.75rem; font-style: italic; display: block; padding: 0.5rem; text-align: center;">No hay ítems configurados.</span>';
                return;
            }

            activeAreaChecklistItems.forEach((item, index) => {
                ...
                li.innerHTML = `
                    ...
                    <button type="button" onclick="removeActiveAreaChecklistItem(${index})" style="background: none; border: none; color: var(--danger); cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0.1rem;">
        ...
        function submitAreaComunForm(event) {
            ...
            formData.append('checklist_items', JSON.stringify(activeAreaChecklistItems));
        ...
        function editAreaComun(a) {
            ...
            activeAreaChecklistItems = (a.checklist_items || []).map(x => x.item_nombre);
            renderActiveAreaChecklistPreview();
        }
        ...
        function viewGCRecibo(boletaId) {
            fetch(`api.php?action=get_boleta_detalle&boleta_id=${boletaId}`)
                ...
                .then(response => {
                    ...
                    // Combinar egresos para agrupar por bloques
                    const todosEgresos = [...globales, ...torre, ...unidad];

                    // Inicializar bloques de cobro
                    const bloques = {
                    ...
                    todosEgresos.forEach(e => {
                        const catNombre = e.categoria_nombre || '';
                        const firstChar = catNombre.trim().charAt(0);
                        if (['1', '2', '3', '4'].includes(firstChar)) {
                            bloques[firstChar].egresos.push(e);
                            bloques[firstChar].total += parseFloat(e.monto || 0);
                        } else {
                            bloques['otro'].egresos.push(e);
                            bloques['otro'].total += parseFloat(e.monto || 0);
                        }
                    });

                    // Calcular subtotales
                    const sumGlobales = globales.reduce((acc, e) => acc + parseFloat(e.monto || 0), 0);
                    const sumTorre = torre.reduce((acc, e) => acc + parseFloat(e.monto || 0), 0);
                    const sumUnidad = unidad.reduce((acc, e) => acc + parseFloat(e.monto || 0), 0);
                    ...
                    let html = `
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem; color: #333; font-size: 0.85rem;">
                            ...
                            <div style="border: 1px solid #ddd; padding: 0.75rem; border-radius: 6px; background: #fafafa;">
                                ...
                                <table style="width: 100%; border: none; margin: 0;">
                                    ...
                                    <tr style="border: none;"><td style="padding: 0.2rem 0; font-weight: 600; width: 110px; border: none;">F. Vencimiento:</td><td style="padding: 0.2rem 0; border: none;">${formatDisplayDate(period.fecha_tope)}</td></tr>
                                    <tr style="border: none;"><td style="padding: 0.2rem 0; font-weight: 600; border: none;">Prorrateo:</td><td style="padding: 0.2rem 0; border: none;">${(prorrateoFraccion * 100).toFixed(4)} % (${prop.tipo_unidad_codigo || 'Por Defecto'})</td></tr>
                        ...
                        <h3 style="font-size: 1.05rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0; color: #000; border-bottom: 1px solid #333; padding-bottom: 0.25rem; text-transform: uppercase;">
                            Resumen de Bloques de Cobro del Periodo
                        </h3>
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.8rem; color: #333;">
                            <thead>
                                <tr style="background: #f3f4f6; color: #000;">
                                    <th style="padding: 0.4rem; border: 1px solid #ddd; text-align: left;">Bloque de Cobro</th>
                                    <th style="padding: 0.4rem; border: 1px solid #ddd; text-align: right; width: 180px;">Monto Total Condominio ($)</th>
                                    <th style="padding: 0.4rem; border: 1px solid #ddd; text-align: right; width: 180px;">Mi Prorrateo Directo ($)</th>
                                </tr>
                            </thead>
                            <tbody>
                    `;
                    ...
                    let subtotalCondo = 0;
                    let subtotalMiProrrateo = 0;

                    Object.entries(bloques).forEach(([key, bloque]) => {
                        if (key === 'otro' && bloque.egresos.length === 0) return;

                        const totalBloque = bloque.total;
                        let globalInBloque = 0;
                        bloque.egresos.forEach(eg => {
                            if (eg.propiedad_id === null || eg.propiedad_id === '') {
                                globalInBloque += parseFloat(eg.monto);
                            }
                        });
                        const prorrateoBloque = globalInBloque * prorrateoFraccion;

                        subtotalCondo += totalBloque;
                        subtotalMiProrrateo += prorrateoBloque;

                        html += `
                            <tr>
                                <td style="padding: 0.4rem; border: 1px solid #ddd; font-weight: bold;">${bloque.nombre}</td>
                                <td style="padding: 0.4rem; border: 1px solid #ddd; text-align: right;">$${formatNumber(totalBloque)}</td>
                                <td style="padding: 0.4rem; border: 1px solid #ddd; text-align: right;">$${formatNumber(prorrateoBloque)}</td>
                            </tr>
                        `;
                    });
                    ...
                    html += `
                                <tr style="font-weight: bold; background: #fafafa; border-top: 2px solid #ddd;">
                                    <td style="padding: 0.4rem; border: 1px solid #ddd;">Subtotal Prorrateable:</td>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd; text-align: right;">$${formatNumber(subtotalCondo)}</td>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd; text-align: right;">$${formatNumber(subtotalMiProrrateo)}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <!-- Detalle Cronológico -->
                        <h3 style="font-size: 1.05rem; font-weight: bold; margin: 1.5rem 0 0.5rem 0; color: #000; border-bottom: 1px solid #333; padding-bottom: 0.25rem; text-transform: uppercase;">
                            Detalle Cronológico de Egresos por Bloque
                        </h3>
                    `;

                    Object.entries(bloques).forEach(([key, bloque]) => {
                        if (bloque.egresos.length === 0) return;

                        html += `
                            <h4 style="margin: 1rem 0 0.25rem 0; font-size: 0.9rem; font-weight: bold; color: #2563eb;">${bloque.nombre}</h4>
                            <table style="width: 100%; border-collapse: collapse; margin-bottom: 1rem; font-size: 0.75rem; color: #333;">
                                <thead>
                                    <tr style="background: #f3f4f6; color: #000;">
                                        <th style="padding: 0.4rem; border: 1px solid #ddd; width: 80px;">Fecha</th>
                                        <th style="padding: 0.4rem; border: 1px solid #ddd; width: 150px;">Subcategoría</th>
                                        <th style="padding: 0.4rem; border: 1px solid #ddd;">Descripción</th>
                                        <th style="padding: 0.4rem; border: 1px solid #ddd; text-align: right; width: 110px;">Monto ($)</th>
                                    </tr>
                                </thead>
                                <tbody>
                        `;

                        bloque.egresos.forEach(e => {
                            html += `
                                <tr>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd;">${formatDisplayDate(e.fecha)}</td>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd;">${e.subcategoria_nombre}</td>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd;">${e.descripcion}</td>
                                    <td style="padding: 0.4rem; border: 1px solid #ddd; text-align: right;">$${formatNumber(e.monto)}</td>
                                </tr>
                            `;
                        });
                            ...
                            <div style="width: 320px; border: 1px solid #ddd; border-radius: 6px; padding: 0.75rem; background: #f9f9f9; font-size: 0.8rem;">
                                <table style="width: 100%; border: none; margin: 0;">
                                    <tr style="border: none;">
                                        <td style="padding: 0.25rem 0; border: none;">Base Prorrateable (Global+Torre):</td>
                                    ...
                                    <tr style="border: none;">
                                        <td style="padding: 0.25rem 0; border: none;">Cargos Directos y Multas:</td>
        ...
        function checkPendingInsumosAlert() {
            fetch('api.php?action=get_pedidos_insumos')
                .then(res => res.json())
                .then(response => {
                    const alertBox = document.getElementById('admin-insumos-alert-box');
                    if (!alertBox) return;

                    if (response.success && response.data) {
                        const pendingItems = response.data.filter(item => item.estado === 'pendiente');
                        if (pendingItems.length > 0) {
                            const colabNames = [...new Set(pendingItems.map(item => item.colaborador_nombre))];
                            const text = document.getElementById('admin-insumos-alert-text');
                            text.innerHTML = `Tiene listas de materiales pendientes de revisión para compra de: <strong>${colabNames.join(', ')}</strong> (${pendingItems.length} artículos en total).`;
        ...
        function openAdminInsumosModal() {
            document.getElementById('modal-admin-insumos').classList.add('active');
            loadAdminInsumosList();
        }

        function closeAdminInsumosModal() {
            document.getElementById('modal-admin-insumos').classList.remove('active');
        }

        function loadAdminInsumosList() {
            const container = document.getElementById('admin-insumos-lists-container');
            if (!container) return;
            container.innerHTML = '<div style="color:var(--text-muted); font-size:0.85rem; padding:1.5rem; text-align:center;">Cargando pedidos de materiales...</div>';

            fetch('api.php?action=get_pedidos_insumos')
                .then(res => res.json())
                .then(response => {
                    if (response.success && response.data) {
                        renderAdminInsumosLists(response.data);
                    } else {
                        container.innerHTML = '<div style="color:var(--text-muted); font-size:0.85rem; padding:1.5rem; text-align:center;">No hay registros de pedidos.</div>';
                    }
                })
                .catch(() => {
                    container.innerHTML = '<div style="color:var(--text-muted); font-size:0.85rem; padding:1.5rem; text-align:center;">Error al cargar los pedidos.</div>';
                });
        }

        function renderAdminInsumosLists(items) {
            const container = document.getElementById('admin-insumos-lists-container');
            container.innerHTML = '';

            if (items.length === 0) {
                container.innerHTML = '<div style="color:var(--text-muted); font-size:0.85rem; padding:1.5rem; text-align:center; font-style:italic;">No hay pedidos de insumos registrados.</div>';
                return;
            }
            ...
            Object.values(groups).forEach(group => {
                ...
                groupPanel.style.border = '1px solid var(--border-color)';
                groupPanel.style.borderRadius = '10px';
                groupPanel.style.background = 'rgba(255,255,255,0.01)';
                groupPanel.style.overflow = 'hidden';

                const pendingGroupItems = group.items.filter(i => i.estado === 'pendiente');
                const hasPending = pendingGroupItems.length > 0;
                
                let checkGeneralHtml = '';
                if (hasPending) {
                    checkGeneralHtml = `
                        <div style="background: rgba(245, 158, 11, 0.05); padding: 0.75rem; border-top: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem;">
                            <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.8rem; color: #fff; cursor: pointer; font-weight: 600;">
                                <input type="checkbox" id="check-general-compra-${group.colaborador_id}" style="width: 16px; height: 16px; accent-color: #fbbf24;"> He visto la lista y ejecutaré la compra
                            </label>
                            <button class="btn btn-secondary" onclick="submitBulkApproveInsumos(${group.colaborador_id})" style="font-size: 0.75rem; padding: 0.35rem 0.75rem; background: #fbbf24; color: #111827; border: none; height: auto; font-weight: 600;">
                                Confirmar Compra
                            </button>
                        </div>
                    `;
                ...
                const enCompraGroupItems = group.items.filter(i => i.estado === 'en_compra');
                const hasEnCompra = enCompraGroupItems.length > 0;
                
                let registerBuyHtml = '';
                if (hasEnCompra) {
                    registerBuyHtml = `
                        <div style="background: rgba(16, 185, 129, 0.05); padding: 0.75rem; border-top: 1px solid var(--border-color); display: flex; flex-direction: column; gap: 0.5rem;">
                            <span style="font-size: 0.8rem; font-weight: 700; color: #fff; display: block;">Registrar Compra de Materiales:</span>
                            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap; align-items: center;">
                                <input type="text" id="admin-insumo-doc-num-${group.colaborador_id}" class="form-control" placeholder="N° Factura o Boleta" style="flex: 1; font-size: 0.8rem; height: 34px; padding: 0 0.5rem; background: rgba(0,0,0,0.2); border: 1px solid var(--border-color); color: #fff; border-radius: 6px;">
                                <button class="btn btn-primary" onclick="submitInsumosComprados(${group.colaborador_id})" style="font-size: 0.75rem; padding: 0 0.75rem; height: 34px; background: #10b981; border: none; border-radius: 6px; display: flex; align-items: center; gap: 0.25rem; cursor: pointer; color: #fff; font-weight: 600;">
                                    Marcar Comprado
                                </button>
                            </div>
                        </div>
                ...
                groupPanel.innerHTML = `
                    <div style="background: rgba(255,255,255,0.02); padding: 0.75rem 1rem; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-weight: 700; color: #fff; font-size: 0.9rem;">${escapeHtml(group.colaborador_nombre)}</span>
                        <span style="font-size: 0.75rem; color: var(--text-secondary);">${group.items.length} artículos solicitados</span>
                    </div>
                    <div style="padding: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
                        ${group.items.map(i => {
                            let badgeStyle = '';
                            let badgeText = i.estado;
                            let docInfo = '';
                            
                            if (i.estado === 'pendiente') {
                                badgeStyle = 'background: rgba(245, 158, 11, 0.1); color: #fbbf24; border: 1px solid rgba(245, 158, 11, 0.25);';
                            } else if (i.estado === 'en_compra') {
                                badgeStyle = 'background: rgba(59, 130, 246, 0.1); color: #3b82f6; border: 1px solid rgba(59, 130, 246, 0.25);';
                            } else if (i.estado === 'comprado') {
                                badgeStyle = 'background: rgba(16, 185, 129, 0.1); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.25);';
                                badgeText = 'Comprado';
                                docInfo = `<div style="font-size:0.75rem; color: #10b981; font-weight:600; margin-top:2px;">Factura/Boleta: #${escapeHtml(i.numero_documento)}</div>`;
                            } else if (i.estado === 'recibido') {
                                badgeStyle = 'background: rgba(16, 185, 129, 0.2); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.5); font-weight: bold;';
                                badgeText = 'Llegó';
                                docInfo = `<div style="font-size:0.75rem; color: var(--text-secondary); margin-top:2px;">Entregado a colaborador (Doc: #${escapeHtml(i.numero_documento)})</div>`;
                            } else {
                                badgeStyle = 'background: rgba(255, 255, 255, 0.05); color: var(--text-secondary);';
                            }
                            
                            let selectCheckbox = '';
                            if (i.estado === 'en_compra') {
                                selectCheckbox = `
                                    <input type="checkbox" class="admin-insumo-select-buy-${group.colaborador_id}" value="${i.id}" style="width:16px; height:16px; accent-color:#10b981; margin-right: 0.5rem; cursor:pointer;" checked>
                                `;
                            }
                            
                            return `
                                <div style="display: flex; align-items: flex-start; gap: 0.25rem; border-bottom: 1px solid rgba(255,255,255,0.02); padding-bottom: 0.5rem;">
                                    ${selectCheckbox}
                                    <div style="flex: 1;">
                                        <div style="font-weight: 600; color: #fff;">${escapeHtml(i.item_nombre)} <span style="color: var(--text-secondary); font-size: 0.75rem;">(x${i.cantidad})</span></div>
                                        <div style="font-size: 0.75rem; color: var(--text-secondary); text-transform: capitalize;">Categoría: ${i.categoria}</div>
                                        ${i.observaciones ? `<div style="font-size: 0.75rem; color: var(--text-muted); font-style: italic; margin-top: 2px;">"${escapeHtml(i.observaciones)}"</div>` : ''}
                                        ${docInfo}
                                    </div>
                                    <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.25rem; flex-shrink: 0;">
                                        <span style="font-size: 0.7rem; padding: 2px 6px; border-radius: 4px; font-weight: 700; text-transform: uppercase; ${badgeStyle}">${badgeText}</span>
                                        <span style="font-size: 0.7rem; color: var(--text-muted);">${formatDisplayDate(i.fecha_pedido.split(' ')[0])}</span>
                                    </div>
                                </div>
                            `;
                        }).join('')}
        ...
        function submitBulkApproveInsumos(colaboradorId) {
            const checkbox = document.getElementById(`check-general-compra-${colaboradorId}`);
            if (!checkbox || !checkbox.checked) {
                showToast('Por favor, marque la casilla para confirmar que revisó la lista y ejecutará la compra.', 'warning');
                return;
            }
            ...
            fetch('api.php?action=bulk_approve_pedidos_insumos', {
                method: 'POST',
                body: formData
            })
                .then(res => res.json())
                ...
                .catch(() => showToast('Error al confirmar la lista de compra.', 'error'));
        }

        function submitInsumosComprados(colaboradorId) {
            const docInput = document.getElementById(`admin-insumo-doc-num-${colaboradorId}`);
            const docNum = docInput ? docInput.value.trim() : '';
            
            if (!docNum) {
                showToast('Por favor, ingrese el número de factura o boleta.', 'warning');
                return;
            }

            const checkedBoxes = document.querySelectorAll(`.admin-insumo-select-buy-${colaboradorId}:checked`);
            if (checkedBoxes.length === 0) {
                showToast('Por favor, seleccione al menos un artículo para registrar la compra.', 'warning');
                return;
            }
            ...
            formData.append('numero_documento', docNum);

            fetch('api.php?action=mark_pedidos_comprados', {
                method: 'POST',
                body: formData
            })
                .then(res => res.json())
                ...
                .catch(() => showToast('Error al registrar la compra.', 'error'));
        }
                                ...
                                <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 8px; padding: 1.2rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                                    ...
                                    <div style="text-align: right;">
                                        ...
                                        <div style="display: flex; gap: 0.5rem; justify-content: flex-end; align-items: center; margin-top:0.4rem;">
                                            ${estadoBadge}
                                            <button class="btn btn-primary" onclick="viewGCRecibo(${recent.boleta.id})" style="padding:0.3rem 0.6rem; font-size:0.75rem; background: var(--accent-color); border: none; color: #fff; display: flex; align-items: center; gap: 0.25rem;"><i data-lucide="eye" style="width:12px; height:12px;"></i> Detalle</button>
                                ...
                                tr.innerHTML = `
                                    ...
                                    <td style="padding: 0.6rem 0.5rem; text-align: center;">
                                        <div style="display: flex; gap: 0.25rem; justify-content: center; align-items: center;">
                                            <button class="btn btn-primary" onclick="viewGCRecibo(${item.boleta.id})" style="font-size:0.7rem; padding:0.25rem 0.5rem; background: var(--accent-color); border: none; color: #fff; display: inline-flex; align-items: center; gap: 0.2rem;">
                                                <i data-lucide="eye" style="width:12px; height:12px;"></i> Detalle
                                            </button>
                                            <button class="btn btn-secondary" onclick="downloadPortalUsuarioBoleta(${item.boleta.id})" style="font-size:0.7rem; padding:0.25rem 0.5rem; display: inline-flex; align-items: center; gap: 0.2rem;">
        ...
        // --- Colaboradores Portal: Calendario de Arriendos y Checklist ---
        let colabCurrentDate = new Date();
        let colabGlobalAreas = [];
        let colabGlobalList = [];
        let activeReservaChecklist = null;

        function loadColabArriendos() {
            const pAreas = fetch('api.php?action=get_areas_comunes').then(res => res.json());
            const pArriendos = fetch('api.php?action=get_arriendos').then(res => res.json());

            Promise.all([pAreas, pArriendos])
                .then(([resAreas, resArriendos]) => {
                    if (resAreas.success) {
                        colabGlobalAreas = resAreas.data;
                        renderColabAreasLegend();
                    }
                    if (resArriendos.success) {
                        colabGlobalList = resArriendos.data;
                    }
                    renderColabArriendoCalendar();
                })
                .catch(() => showToast('Error al cargar datos del calendario de áreas.', 'error'));
        }

        function changeColabCalendarMonth(direction) {
            colabCurrentDate.setMonth(colabCurrentDate.getMonth() + direction);
            renderColabArriendoCalendar();
        }

        function renderColabAreasLegend() {
            const legend = document.getElementById('colab-areas-legend');
            if (!legend) return;
            legend.innerHTML = '';
            colabGlobalAreas.forEach(a => {
                const item = document.createElement('div');
                item.style.display = 'flex';
                item.style.alignItems = 'center';
                item.style.gap = '0.25rem';
        ...
        function renderColabArriendoCalendar() {
            const grid = document.getElementById('colab-calendar-grid');
            const title = document.getElementById('colab-calendar-month-title');
            if (!grid || !title) return;

            grid.innerHTML = '';

            const year = colabCurrentDate.getFullYear();
            const month = colabCurrentDate.getMonth();

            title.innerText = `${getMonthName(`${year}-${String(month + 1).padStart(2, '0')}`)} ${year}`;

            const firstDayOfMonth = new Date(year, month, 1);
            let startDayOfWeek = firstDayOfMonth.getDay();
            startDayOfWeek = startDayOfWeek === 0 ? 6 : startDayOfWeek - 1; // Ajuste Lunes-Domingo
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                cell.style.background = isToday ? 'rgba(72, 136, 145, 0.07)' : 'rgba(255, 255, 255, 0.02)';
                cell.style.borderRight = '1px solid var(--border-color)';
                cell.style.borderBottom = '1px solid var(--border-color)';
                cell.style.padding = '0.5rem';
                cell.style.minHeight = '90px';
                ...
                cell.innerHTML = `<span style="font-size: 0.75rem; color: ${isToday ? '#488891' : '#fff'}; font-weight: 700;">${day}</span>`;

                const dayBookingsContainer = document.createElement('div');
                dayBookingsContainer.style.display = 'flex';
                dayBookingsContainer.style.flexDirection = 'column';
                dayBookingsContainer.style.gap = '2px';
                dayBookingsContainer.style.overflow = 'hidden';

                const dayBookings = colabGlobalList.filter(b => b.fecha === dateStr);
                dayBookings.forEach(b => {
                    const badge = document.createElement('div');
                    badge.className = 'arriendo-badge';
                    badge.style.background = b.area_color || '#3b82f6';
                    ...
                    let statusLabel = '';
                    if (b.estado === 'pendiente') statusLabel = '🕒';
                    else if (b.estado === 'entregado') statusLabel = '🔑';
                    else if (b.estado === 'realizado') statusLabel = '✅';

                    badge.innerHTML = `<span>${b.hora_inicio.substring(0,5)} ${b.area_nombre} ${statusLabel}</span>`;
                    badge.title = `${b.area_nombre} - ${b.propiedad_identificador}\nEstado: ${b.estado.toUpperCase()}`;
                    badge.onclick = () => openChecklistRegistroModal(b);
                    dayBookingsContainer.appendChild(badge);
                });
        ...
        function openChecklistRegistroModal(b) {
            activeReservaChecklist = b;
            document.getElementById('modal-checklist-registro').classList.add('active');
            document.getElementById('checklist-arriendo-id').value = b.id;
            
            const infoDiv = document.getElementById('checklist-info-reserva');
            infoDiv.innerHTML = `
                <div><strong style="color: #fff;">Área Común:</strong> ${b.area_nombre}</div>
                <div><strong style="color: #fff;">Unidad Reservada:</strong> ${b.propiedad_identificador}</div>
                <div><strong style="color: #fff;">Fecha y Horario:</strong> ${formatDisplayDate(b.fecha)} (${b.hora_inicio.substring(0,5)} a ${b.hora_fin.substring(0,5)})</div>
                <div><strong style="color: #fff;">Estado Actual:</strong> <span style="text-transform: uppercase; font-weight: 700; color: ${b.estado === 'realizado' ? '#10b981' : (b.estado === 'entregado' ? '#488891' : '#f59e0b')}">${b.estado}</span></div>
            `;

            // Reset logs summary
            let existingSummaryDiv = document.getElementById('checklist-logs-summary');
            if (existingSummaryDiv) existingSummaryDiv.remove();

            const form = document.getElementById('form-checklist-registro');
            const submitBtn = document.getElementById('btn-save-checklist');

            if (b.estado === 'pendiente') {
                document.getElementById('checklist-modal-title').innerText = `Entrega de Recinto: ${b.area_nombre}`;
                document.getElementById('checklist-tipo').value = 'entrega';
                submitBtn.innerText = 'Finalizar Entrega y Registrar Apertura';
                submitBtn.style.display = 'block';
                form.style.display = 'block';
                renderChecklistFormItems(b.area_comun_id);
            } 
            else if (b.estado === 'entregado') {
                document.getElementById('checklist-modal-title').innerText = `Recepción de Recinto: ${b.area_nombre}`;
                document.getElementById('checklist-tipo').value = 'recepcion';
                submitBtn.innerText = 'Finalizar Recepción y Registrar Cierre';
                submitBtn.style.display = 'block';
                form.style.display = 'block';
                renderChecklistFormItems(b.area_comun_id);

                // Fetch delivery logs to show at top
                fetch(`api.php?action=get_checklist_registros&arriendo_id=${b.id}`)
                    .then(res => res.json())
                    .then(response => {
                        if (response.success && response.data && response.data.length > 0) {
                            showChecklistLogsComparison(response.data);
                        }
                    });
            } 
            else if (b.estado === 'realizado') {
                document.getElementById('checklist-modal-title').innerText = `Historial de Chequeo: ${b.area_nombre}`;
                submitBtn.style.display = 'none';
                form.style.display = 'none';

                // Fetch both delivery and reception logs
                fetch(`api.php?action=get_checklist_registros&arriendo_id=${b.id}`)
                    .then(res => res.json())
                    .then(response => {
                        if (response.success && response.data) {
        ...
        function closeChecklistRegistroModal() {
            document.getElementById('modal-checklist-registro').classList.remove('active');
            activeReservaChecklist = null;
        }

        function renderChecklistFormItems(areaId) {
            const container = document.getElementById('checklist-items-container');
            container.innerHTML = '';
            
            const area = colabGlobalAreas.find(a => a.id == areaId);
            const items = (area && area.checklist_items) ? area.checklist_items : [];
            
            if (items.length === 0) {
                container.innerHTML = '<div style="color: var(--text-secondary); font-size: 0.85rem; font-style: italic; padding: 0.5rem; text-align: center;">Esta área común no tiene una lista de chequeo configurada por el administrador. Se realizará el registro sin ítems adicionales.</div>';
                return;
            }
            ...
            items.forEach(item => {
                ...
                itemDiv.innerHTML = `
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                        <span style="font-size: 0.85rem; font-weight: 600; color: #fff;">${escapeHtml(item.item_nombre)}</span>
                        <div style="display: flex; gap: 0.75rem;">
                            <label style="display: flex; align-items: center; gap: 0.25rem; font-size: 0.8rem; cursor: pointer; color: #10b981;">
                                <input type="radio" name="estado_item_${item.id}" value="ok" checked style="accent-color: #10b981;"> OK
                            </label>
                            <label style="display: flex; align-items: center; gap: 0.25rem; font-size: 0.8rem; cursor: pointer; color: #f59e0b;">
                                <input type="radio" name="estado_item_${item.id}" value="observacion" style="accent-color: #f59e0b;"> Obs.
                            </label>
                        </div>
                    </div>
                    <div>
                        <input type="text" id="comentario_item_${item.id}" class="form-control" placeholder="Escriba comentarios u observaciones sobre el estado..." style="font-size: 0.8rem; padding: 0.35rem 0.5rem; height: 32px;">
                    </div>
                    <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
                        <label for="foto_item_${item.id}" class="btn btn-secondary" style="font-size: 0.75rem; padding: 0.35rem 0.6rem; cursor: pointer; display: flex; align-items: center; gap: 0.25rem; margin: 0; min-width: auto; height: auto;">
                            <i data-lucide="camera" style="width: 14px; height: 14px;"></i> Tomar/Subir Foto
                        </label>
                        <input type="file" id="foto_item_${item.id}" name="foto_item_${item.id}" accept="image/*" capture="environment" style="display: none;" onchange="previewChecklistImage(this, ${item.id})">
                        <span id="label_foto_item_${item.id}" style="font-size: 0.75rem; color: var(--text-secondary); font-style: italic;">Sin foto adjunta (opcional)</span>
                        <div id="preview_foto_item_${item.id}" style="display: none; margin-top: 0.25rem;">
                            <img src="" style="max-width: 120px; max-height: 80px; border-radius: 4px; border: 1px solid var(--border-color);">
                        </div>
                    </div>
                `;
        ...
        function previewChecklistImage(input, itemId) {
            const label = document.getElementById(`label_foto_item_${itemId}`);
            const previewDiv = document.getElementById(`preview_foto_item_${itemId}`);
            ...
            if (input.files && input.files[0]) {
                ...
                if (label) label.textContent = 'Sin foto adjunta (opcional)';
                if (previewDiv) previewDiv.style.display = 'none';
            }
        }

        function showChecklistLogsComparison(logs) {
            const infoDiv = document.getElementById('checklist-info-reserva');
            
            const summaryDiv = document.createElement('div');
            summaryDiv.id = 'checklist-logs-summary';
            ...
            logs.forEach(log => {
                ...
                logPanel.style.border = '1px solid var(--border-color)';
                logPanel.style.background = log.tipo === 'entrega' ? 'rgba(72,136,145,0.05)' : 'rgba(16,185,129,0.05)';
                logPanel.style.borderRadius = '8px';
                logPanel.style.padding = '0.75rem';
                
                const badgeColor = log.tipo === 'entrega' ? '#488891' : '#10b981';
                ...
                if (log.detalles && log.detalles.length > 0) {
                    detailsHtml = `
                        <div style="margin-top: 0.5rem; display: flex; flex-direction: column; gap: 0.4rem;">
                            ${log.detalles.map(d => {
                                const photoHtml = d.foto_ruta 
                                    ? `<a href="${d.foto_ruta}" target="_blank" style="display:block; margin-top:0.25rem;"><img src="${d.foto_ruta}" style="max-width: 120px; border-radius:4px; border:1px solid var(--border-color);"></a>`
                                    : '';
                                return `
                                    <div style="font-size: 0.8rem; border-top: 1px solid rgba(255,255,255,0.02); padding-top: 0.35rem;">
                                        <strong>${escapeHtml(d.item_nombre)}:</strong> 
                                        <span style="font-weight: 700; color: ${d.estado === 'ok' ? '#10b981' : '#f59e0b'}; text-transform: uppercase;">${d.estado}</span>
                                        ${d.comentarios ? `<div style="font-style:italic; color: var(--text-secondary); margin-left: 0.5rem;">"${escapeHtml(d.comentarios)}"</div>` : ''}
                                        ${photoHtml}
                                    </div>
                                `;
                            }).join('')}
                    ...
                    detailsHtml = '<div style="font-size:0.8rem; color:var(--text-secondary); font-style:italic; margin-top:0.25rem;">Sin ítems registrados.</div>';
                }
                ...
                logPanel.innerHTML = `
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); padding-bottom: 0.25rem;">
                        <span style="font-weight: 700; color: ${badgeColor}; text-transform: uppercase; font-size: 0.8rem;">Registro de ${log.tipo}</span>
                        <span style="font-size: 0.75rem; color: var(--text-secondary);">${formatDisplayDate(log.fecha_hora.split(' ')[0])} ${log.fecha_hora.split(' ')[1] || ''}</span>
                    </div>
                    <div style="font-size: 0.8rem; margin-top: 0.35rem;">
                        <strong>Colaborador:</strong> ${escapeHtml(log.colaborador_nombre)}
                    </div>
                    ${detailsHtml}
                `;
                summaryDiv.appendChild(logPanel);
            });

            infoDiv.appendChild(summaryDiv);
        }

        function submitChecklistRegistroForm(event) {
            event.preventDefault();
            const id = document.getElementById('checklist-arriendo-id').value;
            const tipo = document.getElementById('checklist-tipo').value;
            
            if (!currentPortalColaboradorId) {
                showToast('Colaborador no identificado. Seleccione su ficha primero.', 'error');
                return;
            }

            const area = colabGlobalAreas.find(a => a.id === activeReservaChecklist.area_comun_id);
            const items = (area && area.checklist_items) ? area.checklist_items : [];
            ...
            items.forEach(item => {
                const checkedRadio = document.querySelector(`input[name="estado_item_${item.id}"]:checked`);
                const estado = checkedRadio ? checkedRadio.value : 'ok';
                const comentarios = document.getElementById(`comentario_item_${item.id}`).value;
                ...
                const fileInput = document.getElementById(`foto_item_${item.id}`);
                if (fileInput && fileInput.files && fileInput.files[0]) {
                    formData.append(`foto_item_${item.id}`, fileInput.files[0]);
                }
            });
            
            formData.append('arriendo_id', id);
            formData.append('colaborador_id', currentPortalColaboradorId);
            formData.append('tipo', tipo);
            formData.append('detalles', JSON.stringify(detalles));
            
            fetch('api.php?action=save_checklist_registro', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
            .then(response => {
                if (response.success) {
                    showToast(response.message, 'success');
                    closeChecklistRegistroModal();
                    loadColabArriendos();
                } else {
                    showToast(response.message, 'error');
                }
            })
            .catch(() => showToast('Error al registrar lista de chequeo.', 'error'));
        }
        ...
        function loadPortalColaboradorPedidos() {
            ...
            .then(response => {
                ...
                if (response.success && response.data) {
                    ...
                    if (pedidos.length === 0) {
                        tbody.innerHTML = '<tr><td colspan="5" style="text-align:center; color:var(--text-secondary); padding:1rem; font-style:italic;">No has solicitado insumos.</td></tr>';
                        return;
                    }
                    pedidos.forEach(p => {
                        const tr = document.createElement('tr');
                        ...
                        if (p.estado === 'comprado') {
                            extraInfo = `<div style="font-size: 0.7rem; color: #10b981; font-weight: 500;">Comprado (Doc: #${escapeHtml(p.numero_documento)})</div>`;
                        } else if (p.estado === 'recibido') {
                            extraInfo = `<div style="font-size: 0.7rem; color: var(--text-secondary);">Recibido (Doc: #${escapeHtml(p.numero_documento)})</div>`;
                        }

                        let actionHtml = '';
                        if (p.estado === 'pendiente') {
                            actionHtml = `
                                <button class="btn btn-danger" onclick="deletePortalColaboradorInsumo(${p.id})" style="padding: 0.2rem 0.4rem; font-size: 0.7rem; min-width: auto; height: auto; background: var(--danger); border: none;" title="Eliminar artículo de la lista activa">
                                    <i data-lucide="trash-2" style="width: 12px; height: 12px;"></i>
                                </button>
                            `;
                        } else if (p.estado === 'comprado') {
                            actionHtml = `
                                <button class="btn btn-success" onclick="markPortalPedidoRecibido(${p.id})" style="padding: 0.25rem 0.5rem; font-size: 0.7rem; min-width: auto; height: auto; background: #10b981; border: none; color: #fff; font-weight: 600; cursor: pointer; border-radius: 4px;" title="Confirmar recepción del material">
                                    Llegó
                                </button>
                            `;
                        } else if (p.estado === 'recibido') {
                            actionHtml = `
                                <span title="Artículo recibido y entregado" style="color: #10b981; display: inline-flex; align-items: center; justify-content: center; width: 100%;">
                                    <i data-lucide="check-circle" style="width: 14px; height: 14px;"></i>
                                </span>
                            `;
                        } else {
                            actionHtml = `
                                <span title="Artículo bloqueado por compra en proceso" style="color: var(--warning); display: inline-flex; align-items: center; justify-content: center; width: 100%;">
                        ...
                        tr.innerHTML = `
                            <td style="padding:0.5rem; color:#fff; font-weight:600;">
                                ${escapeHtml(p.item_nombre)}
                                ${extraInfo}
                            </td>
                            ...
                            <td style="padding:0.5rem; text-align:center;">
                                <span class="badge ${badgeClass}" style="font-size:0.65rem; padding:0.15rem 0.3rem; ${badgeStyle}">${p.estado === 'recibido' ? 'Llegó' : (p.estado === 'comprado' ? 'Comprado' : p.estado)}</span>
                            </td>
                            <td style="padding:0.5rem; text-align:center;">
                                ${actionHtml}
                            </td>
                    ...
                    tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; color:var(--danger); padding:1rem;">${response.message || 'Error al cargar solicitudes.'}</td></tr>`;
                }
            })
            .catch(() => {
                const tbody = document.getElementById('tbody-portal-colaborador-pedidos');
                if (tbody) {
                    tbody.innerHTML = '<tr><td colspan="5" style="text-align:center; color:var(--danger); padding:1rem;">Error de conexión al servidor.</td></tr>';
                }
            });
        }

        function markPortalPedidoRecibido(id) {
            if (!confirm('¿Confirma que este material llegó y lo ha recibido con éxito?')) return;

            const formData = new FormData();
            formData.append('id', id);

            fetch('api.php?action=mark_pedido_recibido', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
            ...
            .catch(() => showToast('Error al actualizar el estado del artículo.', 'error'));
        }

        function deletePortalColaboradorInsumo(id) {
            if (!confirm('¿Está seguro de que desea eliminar este artículo de su lista activa?')) return;

            const formData = new FormData();
            formData.append('id', id);

            fetch('api.php?action=delete_pedido_insumo', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
            ...
            .catch(() => showToast('Error al eliminar el artículo.', 'error'));
        }
