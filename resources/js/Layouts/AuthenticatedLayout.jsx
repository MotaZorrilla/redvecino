...
export default function AuthenticatedLayout({ header, children, hideNav = false }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-slate-950 text-gray-900 dark:text-slate-100 transition-colors duration-300">
            {!hideNav && (
                <nav className="border-b border-gray-100 dark:border-slate-800/80 bg-white dark:bg-slate-900 transition-colors duration-300">
                            ...
                            <div className="hidden sm:ms-6 sm:flex sm:items-center">
                                <div className="relative ms-3">
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content contentClasses="py-1 bg-white dark:bg-slate-900 border dark:border-slate-800 rounded-md shadow-lg">
                                            <Dropdown.Link
            ...
            {!hideNav && header && (
                <header className="bg-white dark:bg-slate-900 shadow border-b dark:border-slate-850 transition-colors duration-300">
