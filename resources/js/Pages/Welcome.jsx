...
import MobileAppSimulator from '@/Components/Welcome/MobileAppSimulator';
import RoleSimulatorPanel from '@/Components/Welcome/RoleSimulatorPanel';
            ...
            <section id="simulator" className="py-24 border-t border-slate-200/50 dark:border-white/5 bg-white/40 dark:bg-brand-navy/20 backdrop-blur-md relative transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <RoleSimulatorPanel 
                        ...
                        rolesInfo={rolesInfo}
                        simulatedDarkMode={simulatedDarkMode}
                        setSimulatedDarkMode={setSimulatedDarkMode}
