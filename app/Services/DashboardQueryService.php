...
{
    /**
     * Reúne todas las estadísticas y colecciones para el renderizado del Dashboard.
     */
    public function getDashboardData(User $user): array
    {
        ...
        $allCondominiums = Condominium::with(['properties', 'towers'])->get();
        ...
        $allUsers = User::with(['roles', 'ownerProfile.property', 'residentProfile.property'])->get()->map(function($u) {
            $condoId = null;
            if ($u->ownerProfile && $u->ownerProfile->property) {
                $condoId = $u->ownerProfile->property->condominium_id;
            } elseif ($u->residentProfile && $u->residentProfile->property) {
                $condoId = $u->residentProfile->property->condominium_id;
            }
